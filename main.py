...
class EventHandler():
      ...
      def stage_handler(self):
            ...
            button2 = Button(self.root, text = "Gerudo Dungeon", width = 18, height = 2,
                            command = self.world2)
            button3 = Button(self.root, text = "Boloto", width = 18, height = 2,
                            command = self.world3)
      ...
      def world3(self):
            self.root.destroy()
            background.bgimage = pygame.image.load("boloto.png").convert_alpha()
            ground.image = pygame.image.load("bolotopol.png").convert_alpha()
            pygame.time.set_timer(self.enemy_generation3, 2000)
            self.world = 3
            button.imgdisp = 1
            castle.hide = True
            self.battle = True
      ...
      def next_stage(self):  # Code for when the next stage is clicked            
            ...
            if self.world == 1:
                  ...
                  pygame.time.set_timer(self.enemy_generation3, 2500 - (10 * self.stage))
